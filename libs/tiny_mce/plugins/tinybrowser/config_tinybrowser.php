...
session_start();
$tinybrowser['sessioncheck'] = 'upload_dir'; //name of session variable to check

// Random string used to secure Flash upload if session control not enabled - be sure to change!
$tinybrowser['obfuscate'] = 'yeah';
...
$tinybrowser['path']['image'] = $_SESSION["upload_dir"].'/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $_SESSION["upload_dir"].'/media/'; // Media files location
$tinybrowser['path']['file']  = $_SESSION["upload_dir"].'/files/'; // Other files location

/*
$tinybrowser['path']['image'] = $pz_user_dir."/images/";$tinybrowser['path']['media'] = $pz_user_dir."/media";$tinybrowser['path']['file']  = $pz_user_dir."/files";
*/
