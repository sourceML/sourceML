...
<form name="album_form" action="<?= $this->url("users/albums/edit", array("id" => $_GET[$this->param("id")])) ?>" method="post" enctype="multipart/form-data">
  <ul class="form">
    ...
    <li>
      ...
      <div class="form_values"><p>
        ...
        <img src="<?= $this->out["album"]["image_uri"] ?>" /><br /><br />
    ...
    <li>
      ...
      <select name="licence" id="licence">
        <option value="0"<?= $this->out["album"]["licence"] == 0 ? "selected=\"selected\"" : "" ?>>licences pr&eacute;cis&eacute;es dans le contenu</option>
