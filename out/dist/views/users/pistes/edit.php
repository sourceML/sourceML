...
morceaux["<?= $id_groupe ?>"]["<?= $id_album ?>"]["<?= $id_morceau ?>"] = "<?= $_morceau["titre"] ?>";
<?php endforeach; ?>
<?php endforeach; ?>
<?php endforeach; ?>
var derivations = {};
...
<form name="piste_form" action="<?= $this->url("users/pistes/edit", array("id" => $_GET[$this->param("id")])) ?>" method="post">

  <input type="hidden" name="date_inscription" value="<?= $this->out["piste"]["date_inscription"] ?>" />
